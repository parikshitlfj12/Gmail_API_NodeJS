...
function authorize(credentials, callback) {
    var clientSecret = 'O28t5QHbyGrfKrL9Yvxt_X4E';
    var clientId = '822988449195-uep44ergugu30579vpjtegvjr9deggh7.apps.googleusercontent.com';
...
function getAuth(auth){
    ...
    var obj = new Mail(auth, "parikshit.s18@iiits.in", 'GMAIL>JS WORKED', 'CHAL GYA', 'mail');
